...
print(
    "data.mean(axis=0)", data.mean(axis=0)
)  # mean of each column-same as above can also use axis='index'
print(
    "data.mean(axis=1)", data.mean(axis=1)
)  # mean of each row-can also use axis='columns'
