...
test_predict = pd.read_csv(
    "/home/ila/PycharmProjects/pythonworks/artificialintelligence/pandas/files/kaggletest.txt"
)  # no survival comumns
...
pd.DataFrame(
    {"PassengerId": test_predict.PassengerId, "Survived": new_pred_class}
).set_index("PassengerId").to_csv("kagglepredict.csv")
