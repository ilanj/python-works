...
@dataclass(frozen=True) #frozen: If true (the default is False), assigning to fields will generate an exception.
class PatientInformation():
    __slots__ = ['name', 'dob'] #storing as a tuple, not a dict which is default, which saves space
    name : str
    dob : str
